...
{
    /// <summary>Path to a built <c>CaptureEngine.exe</c>. Use <see cref="EngineLocator.Resolve"/>.</summary>
    ...
    /// <summary>The plugin under test, driven through its real <see cref="TrackerPluginHost"/> path.</summary>
    public required ITrackerPlugin Plugin { get; init; }
