...
/// </summary>
/// <remarks>
/// DELIBERATE FORK of <c>TrackerSdk.ConsoleSink</c>, not an oversight, and not a candidate for
...
/// <para>
/// Namespace is <c>CaptureEngine</c> rather than <c>CaptureEngine.Core</c> so every engine file and
/// the engine's test project resolve <c>ConsoleSink</c> from their own enclosing namespace, ahead
/// of any <c>using TrackerSdk;</c> at the top of the file. Moving it would make the SDK's copy
