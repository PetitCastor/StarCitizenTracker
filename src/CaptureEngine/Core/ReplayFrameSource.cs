...
internal sealed class ReplayFrameSource : IFrameSource
{
    ...
    public ReplayFrameSource(string directory)
    {
        // Ordinal, not the current culture: culture-aware sorting reorders timestamped names on
        // some locales, and replay order is the whole point of the corpus.
