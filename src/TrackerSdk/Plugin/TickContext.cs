...
public sealed class TickContext
{
    ...
    /// constructor; this exists so a plugin can drive <see cref="ITrackerPlugin.OnTickAsync"/>
    /// without a pipe.
    /// </summary>
    /// <remarks>
    /// TASK-09 moves this to the <c>TrackerSdk.Testing</c> companion package, along with the tick
    ...
    /// <see cref="ITrackerPlugin"/> untestable outside this assembly, which is a worse trade for one
    /// task's duration.
    /// </remarks>
