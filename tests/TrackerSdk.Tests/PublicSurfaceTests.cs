...
{
    /// <summary>
    /// Namespaces a plugin must never have to name. <c>CaptureContracts</c> itself is NOT here:
    ...
    /// under <c>CaptureContracts.Proto</c>, which is.
    /// </summary>
    private static readonly string[] Forbidden =
        ["CaptureContracts.Proto", "Grpc", "Google.Protobuf"];

    [Fact]
    public void PublicSurface_LeaksNoTransportTypes()
    {
        var offenders = typeof(TrackerPluginHost).Assembly.GetExportedTypes()
