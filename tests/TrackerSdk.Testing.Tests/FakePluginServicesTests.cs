...
namespace TrackerSdk.Testing.Tests;
...
public class FakePluginServicesTests
{
    ...
    public void Emit_Records_WithoutPrinting()
    {
        ...
        var record = new TrackerRecord(DateTime.Now, "tracker", TriggerKind.Auto, "raw");
    ...
    {
        var services = new FakePluginServices();
        var roi = new RoiSubscription("panel", new CaptureContracts.RoiRect(0, 0, 10, 10), 1.0, RoiKind.Text);
